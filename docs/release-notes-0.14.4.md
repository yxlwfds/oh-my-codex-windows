...
- Runtime defaults, Codex agent defaults, and `owx explore` fallback behavior now resolve the frontier lane to `gpt-5.5`. Setup and setup and executor worker reasoning defaults now use medium instead of high.

...
- The strongest remaining operator-facing risk is still real tmux / reused-session behavior around `owx question`, deep-interview Stop blocking, and upgrade-triggered setup refresh.

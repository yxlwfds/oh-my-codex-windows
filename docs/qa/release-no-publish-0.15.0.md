...
| Full test suite | `npm test` | FAIL/INCOMPLETE: unrelated environment-sensitive failures surfaced in `owx ask`, explore harness hydration/routing, detached tmux, cross-rebase, and mailbox bridge tests before tool output was lost; worker-4 did not change those areas. |

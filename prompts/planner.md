...
3. When active guidance enables `USE_OMX_EXPLORE_CMD`, use `owx explore` FIRST for simple read-only lookups; use richer analysis for ambiguous planning and fall back normally if the harness is insufficient.

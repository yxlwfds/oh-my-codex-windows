...
> This file extends the general repository standards with Java-specific coding conventions.
...
See local skill: `springboot-patterns` for architectural patterns and design principles.
See local skill: `database-migrations` for relational database synchronization and DDL standards.
